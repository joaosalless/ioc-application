...
export interface DocumentationServiceInterface extends AbstractServiceInterface { }

@injectable()
export class DocumentationService extends AbstractService implements DocumentationServiceInterface {
